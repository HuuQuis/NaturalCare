 ...
 * @author Admin
 */
public class OrderDBcontextt extends DBConnect{
    public int createReturnId(Order order) {
        try {
            ...
            Logger.getLogger(OrderDBcontextt.class.getName()).log(Level.SEVERE, null, ex);
        }
        return 0;
    }
    public List<Order> getAllOrder() {
        ...
        try {
            ...
            Logger.getLogger(CategoryDBContextt.class.getName()).log(Level.SEVERE, null, ex);
        }
        return Orders;
    }
}
